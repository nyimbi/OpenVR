...
int fp_img_save_to_file(struct fp_img *img, const char *path); //added the const part..hope this still works
...
int fp_init(void);
void fp_exit(void);
void fp_close(void); //I added this, not sure why it's missing
