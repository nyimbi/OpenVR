...
public:
    ...
    //Please modify these attributes below carefully because it is now used in DuplicateReg Window as well
    ...
    QString prevWard;
    QString prevMobile;
    QString prevNationalID;

    int prevBzGalleryMaximum;
    int prevBzScoreMaximum;
    //Please modify these attributes above carefully because it is now used in DuplicateReg Window as well
...
private slots:
   ...
   void on_inpDobYear_lostFocus();
    ...
    void processNationalID(QString);
    ...
    void updateAccessCode(QString);
    void acceptDuplicateRegistration();
    void rejectDuplicateRegistration();
    void finishPhotoCapture(int);
    void finishCbtRun(int);
