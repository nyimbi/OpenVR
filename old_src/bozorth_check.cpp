...
int matchThreshold = 18;//was 20
int matchMinutiae = 23;//was 30 before
...
void Bozorth_Check::checkGallery(QString filePath,int printIndex){
    ...
    fullBozorth3Exe.sprintf("./scripts/search.sh %d %d  /opt/openvr/templates/%d.xyt %s",matchThreshold,matchMinutiae,printIndex,shPassword.toUtf8().data());
